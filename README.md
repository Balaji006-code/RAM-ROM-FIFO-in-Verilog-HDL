...
### **1. RAM Module**
```verilog
module ramb (clk,we,addr,din,dout);
input clk;
input we;                 
input [11:0] addr;         
input [7:0] din;          
...
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/b7649d6e-bdb3-4a01-ae51-6770460a1022" />
...
reg [9:0] address_t;
wire [7:0] dout_t;
romb dut(.clk(clk_t),.rst(rst_t),.address(address_t),.dout(dout_t));
initial
begin
clk_t=1'b0;
rst_t=1'b1;
...
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/369d17d3-f7f9-4ce7-9a2a-7df6cccb9283" />



### 3. FIFO Memory Module
```verilog
module fifob(clk,rst,wr_en,rd_en,data_in,full,data_out,empty,count);
input clk;
input rst;
input wr_en;
input [7:0] data_in;
...
fifob uut (clk,rst,wr_en,rd_en,data_in,full,data_out,empty,count );
...
### Simulation Output for FIFO
 ...
 <img width="1919" height="1079" alt="image" src="https://github.com/user-attachments/assets/3d19cd03-8a42-497c-9d23-42d65896e986" />
